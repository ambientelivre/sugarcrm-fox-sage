...
<label for="phone_office">{$label|strip_semicolon}:</label>
</td>
{counter name="fieldsUsed"}
...
<label for="industry">{$label|strip_semicolon}:</label>
</td>
{counter name="fieldsUsed"}
...
<label for="account_type">{$label|strip_semicolon}:</label>
</td>
{counter name="fieldsUsed"}
...
addToValidate('form_QuickCreate_Accounts', 'accounts_ra_ramos_atividade_1_name', 'relate', false,'{/literal}{sugar_translate label='LBL_ACCOUNTS_RA_RAMOS_ATIVIDADE_1_FROM_RA_RAMOS_ATIVIDADE_TITLE' module='Accounts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Accounts', 'cpf_cnpj_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_CPF_CNPJ' module='Accounts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Accounts', 'faturamentos_c', 'iframe', false,'{/literal}{sugar_translate label='LBL_FATURAMENTOS' module='Accounts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Accounts', 'orcamento_c', 'iframe', false,'{/literal}{sugar_translate label='LBL_ORCAMENTO' module='Accounts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Accounts', 'pedidos_c', 'iframe', false,'{/literal}{sugar_translate label='LBL_PEDIDOS' module='Accounts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Accounts', 'titulos_c', 'iframe', false,'{/literal}{sugar_translate label='LBL_TITULOS' module='Accounts' for_js=true}{literal}' );
