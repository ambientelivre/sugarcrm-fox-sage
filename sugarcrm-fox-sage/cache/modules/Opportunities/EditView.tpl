...
<label for="currency_id">{$label|strip_semicolon}:</label>
</td>
{counter name="fieldsUsed"}
...
<label for="date_closed">{$label|strip_semicolon}:</label>
<span class="required">*</span>
</td>
{counter name="fieldsUsed"}
...
<label for="amount">{$label|strip_semicolon}:</label>
<span class="required">*</span>
</td>
{counter name="fieldsUsed"}
...
<label for="opportunity_type">{$label|strip_semicolon}:</label>
</td>
{counter name="fieldsUsed"}
...
<label for="sales_stage">{$label|strip_semicolon}:</label>
<span class="required">*</span>
</td>
{counter name="fieldsUsed"}
...
<label for="lead_source">{$label|strip_semicolon}:</label>
</td>
{counter name="fieldsUsed"}
...
<label for="probability">{$label|strip_semicolon}:</label>
</td>
{counter name="fieldsUsed"}
...
<label for="campaign_name">{$label|strip_semicolon}:</label>
</td>
{counter name="fieldsUsed"}
...
<label for="next_step">{$label|strip_semicolon}:</label>
</td>
{counter name="fieldsUsed"}
