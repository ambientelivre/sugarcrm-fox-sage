...
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_getjspath', 'include/ListView/ListViewGeneric.tpl', 43, false),array('function', 'counter', 'include/ListView/ListViewGeneric.tpl', 124, false),array('function', 'sugar_translate', 'include/ListView/ListViewGeneric.tpl', 138, false),array('function', 'sugar_getimage', 'include/ListView/ListViewGeneric.tpl', 144, false),array('function', 'sugar_ajax_url', 'include/ListView/ListViewGeneric.tpl', 212, false),array('function', 'sugar_evalcolumn_old', 'include/ListView/ListViewGeneric.tpl', 215, false),array('function', 'sugar_field', 'include/ListView/ListViewGeneric.tpl', 217, false),array('modifier', 'replace', 'include/ListView/ListViewGeneric.tpl', 77, false),array('modifier', 'default', 'include/ListView/ListViewGeneric.tpl', 127, false),array('modifier', 'lower', 'include/ListView/ListViewGeneric.tpl', 130, false),array('modifier', 'upper', 'include/ListView/ListViewGeneric.tpl', 133, false),)), $this); ?>
...
<?php $this->assign('currentModule', $this->_tpl_vars['pageData']['bean']['moduleDir']);  $this->assign('singularModule', $this->_tpl_vars['moduleListSingular'][$this->_tpl_vars['currentModule']]);  $this->assign('hideTable', false); ?>
...
&help_action=&key='><?php echo $this->_tpl_vars['APP']['LBL_CLICK_HERE']; ?>
                ...
                <p class="submsg">
                    <?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['APP']['MSG_EMPTY_LIST_VIEW_NO_RESULTS_SUBMSG'])) ? $this->_run_mod_handler('replace', true, $_tmp, "<item1>", $this->_tpl_vars['pageData']['bean']['moduleName']) : smarty_modifier_replace($_tmp, "<item1>", $this->_tpl_vars['pageData']['bean']['moduleName'])))) ? $this->_run_mod_handler('replace', true, $_tmp, "<item4>", $this->_tpl_vars['helpLink']) : smarty_modifier_replace($_tmp, "<item4>", $this->_tpl_vars['helpLink'])); ?>
