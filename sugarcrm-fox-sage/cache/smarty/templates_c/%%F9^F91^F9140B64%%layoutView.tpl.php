<?php /* Smarty version 2.6.11, created on 2013-06-26 10:06:57
         compiled from modules/ModuleBuilder/tpls/layoutView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_translate', 'modules/ModuleBuilder/tpls/layoutView.tpl', 43, false),array('function', 'sugar_help', 'modules/ModuleBuilder/tpls/layoutView.tpl', 51, false),array('function', 'sugar_image', 'modules/ModuleBuilder/tpls/layoutView.tpl', 69, false),array('function', 'counter', 'modules/ModuleBuilder/tpls/layoutView.tpl', 79, false),array('function', 'sugar_getimage', 'modules/ModuleBuilder/tpls/layoutView.tpl', 85, false),array('function', 'eval', 'modules/ModuleBuilder/tpls/layoutView.tpl', 103, false),array('modifier', 'upper', 'modules/ModuleBuilder/tpls/layoutView.tpl', 135, false),array('modifier', 'escape', 'modules/ModuleBuilder/tpls/layoutView.tpl', 250, false),)), $this); ?>
...
'><?php echo $this->_tpl_vars['panelid']; ?>
        ...
        <?php if ($this->_tpl_vars['panelid'] != 'default'): ?>
            <?php ob_start(); ?>class="le_edit" style="float:right; cursor:pointer;" onclick="editPanelProperties('<?php echo $this->_tpl_vars['idCount']; ?>
');"<?php $this->_smarty_vars['capture']['default'] = ob_get_contents();  $this->assign('otherAttributes', ob_get_contents());ob_end_clean(); ?>
            <?php echo smarty_function_sugar_getimage(array('name' => 'edit_inline','ext' => ".gif",'other_attributes' => $this->_tpl_vars['otherAttributes']), $this);?>
