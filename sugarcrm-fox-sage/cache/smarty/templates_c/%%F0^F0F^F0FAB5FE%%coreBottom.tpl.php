<?php /* Smarty version 2.6.11, created on 2013-06-26 14:52:06
         compiled from modules/DynamicFields/templates/Fields/Forms/coreBottom.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_translate', 'modules/DynamicFields/templates/Fields/Forms/coreBottom.tpl', 45, false),array('function', 'html_options', 'modules/DynamicFields/templates/Fields/Forms/coreBottom.tpl', 53, false),array('function', 'sugar_getimage', 'modules/DynamicFields/templates/Fields/Forms/coreBottom.tpl', 54, false),)), $this); ?>
...
:</td><td>
    <?php if ($this->_tpl_vars['hideLevel'] < 5): ?>
		...
		<?php echo smarty_function_sugar_getimage(array('alt' => $this->_tpl_vars['mod_strings']['LBL_HELP'],'name' => 'helpInline','ext' => ".png",'other_attributes' => 'id="importTipIcon" '), $this);?>
...
<?php if ($this->_tpl_vars['hideLevel'] < 5): ?>
    ...
    <?php echo smarty_function_sugar_getimage(array('alt' => $this->_tpl_vars['mod_strings']['LBL_HELP'],'name' => 'helpInline','ext' => ".png",'other_attributes' => 'id="duplicateTipIcon" '), $this);?>
