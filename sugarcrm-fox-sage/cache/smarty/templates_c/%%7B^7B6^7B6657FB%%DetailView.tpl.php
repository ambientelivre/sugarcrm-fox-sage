<?php /* Smarty version 2.6.11, created on 2013-06-28 13:58:00
         compiled from cache/modules/Opportunities/DetailView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_include', 'cache/modules/Opportunities/DetailView.tpl', 33, false),array('function', 'counter', 'cache/modules/Opportunities/DetailView.tpl', 38, false),array('function', 'sugar_translate', 'cache/modules/Opportunities/DetailView.tpl', 47, false),array('function', 'sugar_ajax_url', 'cache/modules/Opportunities/DetailView.tpl', 76, false),array('function', 'sugar_number_format', 'cache/modules/Opportunities/DetailView.tpl', 102, false),array('modifier', 'strip_semicolon', 'cache/modules/Opportunities/DetailView.tpl', 48, false),array('modifier', 'escape', 'cache/modules/Opportunities/DetailView.tpl', 289, false),array('modifier', 'url2html', 'cache/modules/Opportunities/DetailView.tpl', 289, false),array('modifier', 'nl2br', 'cache/modules/Opportunities/DetailView.tpl', 289, false),)), $this); ?>
...
" id="merge_duplicate_button"><?php endif; ?> </li><li><input title="Gerar orçamento" accesskey="I" name="button" value="Gerar orçamento" onclick="window.open('http://portalintegracao.ebs.com.br/Site/Interface/0.0/Faturamento/Orcamento/OrcamentoCadastroViewX.html?SID=&Acao=novo&Nome=Cliente 01&PJPF=&OportunidadeId=63d4a5b3-9b27-b74c-f7e4-50ae26b2fc3b&ContaId=8a340bfb-91f9-fbba-f6ce-51cb15db8265&Email=&RamoAtvidade=&Rua=Rua das alamedas&Bairro=&Cidade=&CEP=&Pais=&Estado=PR','_blank');" type="submit" //></li><li><?php if ($this->_tpl_vars['bean']->aclAccess('detail')):  if (! empty ( $this->_tpl_vars['fields']['id']['value'] ) && $this->_tpl_vars['isAuditEnabled']): ?><input id="btn_view_change_log" title="<?php echo $this->_tpl_vars['APP']['LNK_VIEW_CHANGE_LOG']; ?>
