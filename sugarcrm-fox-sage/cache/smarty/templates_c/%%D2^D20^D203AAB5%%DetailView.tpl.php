<?php /* Smarty version 2.6.11, created on 2013-06-27 15:22:45
         compiled from custom/include/SugarFields/Fields/Iframe/DetailView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugarvar', 'custom/include/SugarFields/Fields/Iframe/DetailView.tpl', 49, false),array('function', 'sugarvar_connector', 'custom/include/SugarFields/Fields/Iframe/DetailView.tpl', 59, false),array('modifier', 'replace', 'custom/include/SugarFields/Fields/Iframe/DetailView.tpl', 51, false),)), $this); ?>
{*
/*********************************************************************************
...
<input type="hidden" class="sugar_field" id="<?php if (empty ( $this->_tpl_vars['displayParams']['idName'] )):  echo smarty_function_sugarvar(array('key' => 'name'), $this); else:  echo $this->_tpl_vars['displayParams']['idName'];  endif; ?>" value="{if ( $linkStart != 'http://' || $linkStart != 'https:/' ) && $link}http://{/if}{$link}">
<iframe src="{if $linkStart != 'http://' && $linkStart != 'https:/' && $link}http://{/if}{$link}{php} echo $extraURL;{/php}" title="{if $linkStart != 'http://' && $linkStart != 'https:/' && $link}http://{/if}{$link}" height="<?php echo smarty_function_sugarvar(array('key' => 'height'), $this);?>
" width="100%" /></iframe>
{/if}
